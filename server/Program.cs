...
app.MapGet("/api/products/{company_id}", ProductRoute.GetProducts);
app.MapPost("/api/products/{company_id}", ProductRoute.PostProduct);
app.MapDelete("/api/products7{company_id}/{id}", ProductRoute.DeleteProduct);
